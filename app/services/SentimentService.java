...
public class SentimentService {
     ...
     */
    public SentimentService(CompletableFuture<List<YTResponse>> Input){
        Input.thenApply(list ->{
            ...
            tempTotalWords = list.stream()
                    ...
                    .count();
            totalWords = (double)tempTotalWords;
            ...
            setFinalOutput(totalWords, happyWords,sadWords);
     ...
     * @return IfContain is a boolean value that means if the word is in the word list.
     */
     ...
     * @author: Jiaxi Liu - 40278106
     * Created: 2024/11/6
     * The method is used to generate the symbol of sentiment according to number of different words.
     * @param totalWords is the number of words in all descriptions.
     * @param happyWords is the number of positive words in all descriptions.
     * @param sadWords is the number of negative words in all descriptions.
     */
    public void setFinalOutput(Double totalWords,Double happyWords,Double sadWords)
    {
