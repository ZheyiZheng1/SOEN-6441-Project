...
public class routes {
  ...
  public static final controllers.ReverseWordCountController WordCountController = new controllers.ReverseWordCountController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseWordCountController WordCountController = new controllers.javascript.ReverseWordCountController(RoutesPrefix.byNamePrefix());
