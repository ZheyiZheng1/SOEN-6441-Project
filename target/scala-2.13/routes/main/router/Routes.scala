...
class Routes(
  ...
  def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:19
    Assets_2: controllers.Assets
  ) = this(errorHandler, HomeController_4, CountController_1, AsyncController_3, TagsController_0, Assets_2, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_4, CountController_1, AsyncController_3, TagsController_0, Assets_2, prefix)
  }
  ...
  private lazy val controllers_HomeController_videoStatistics4_invoker = createInvoker(
    HomeController_4.videoStatistics(fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "videoStatistics",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_HomeController_videoStatistics4_route(params@_) =>
      call(params.fromPath[String]("keyword", None)) { (keyword) =>
        controllers_HomeController_videoStatistics4_invoker.call(HomeController_4.videoStatistics(keyword))
      }
